...
import { CallForPapersPageClient } from '@/components/callForPapersPage/CallForPapersPageClient';
import cfpData from '@/data/callForPapersPage/callForPapers.json'; // Import data for SEO

// --- SEO for the Call for Papers Page ---
export async function generateMetadata(): Promise<Metadata> {
  // Automatically create a list of keywords from the conference themes
  const themeKeywords = cfpData.thematicAreas.map(area => area.theme);
...
export default function CallForPapersPage() {
  return <CallForPapersPageClient />;
}