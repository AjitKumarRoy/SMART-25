...
export const RegistrationAndHospitality = () => {
    ...
    return (
        <Section id="technical" className="bg-gray-50">
            <SectionTitle>{pageData.registrationHospitality.title}</SectionTitle>
             <motion.ul 
            ...
            >
                {pageData.registrationHospitality.members.map(member => (
                    <motion.li 
                        key={member.name}
